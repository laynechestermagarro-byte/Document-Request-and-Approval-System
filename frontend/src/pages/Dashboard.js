          ...
          {activeTab === 'Profile' && (
             <div className="max-w-2xl mx-auto bg-white rounded-[32px] p-10 border border-slate-200 shadow-sm text-center">
                ...
                <div className="mt-10 grid grid-cols-1 gap-4 text-left">
                  ...
                  <ProfileField label="Program" value="BS Computer Science" />
                </div>
             </div>
          )}
        </main>
...
const RequestItem = ({ req, onEdit }) => {
  ...
  // Helper to ensure remarks are readable
  ...
  return (
    <div className="group flex flex-col p-5 rounded-2xl border border-slate-100 hover:border-blue-200 hover:bg-blue-50/30 transition-all">
        ...
        <div className="flex items-center gap-4">
          ...
          {status === 'Rejected' && (
            <button
              ...
              className="px-3 py-1.5 bg-rose-600 text-white text-[9px] font-black uppercase rounded-lg shadow-md hover:bg-rose-700 transition-all"
            >
              View Reason
            </button>
          )}
      ...
      {/* Inline rejection display if status is Rejected */}
